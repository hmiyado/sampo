    ...
    override fun buildProducer(): Observable<UseMapView.Sink.DrawableMap> {
        return Observable
                .combineLatest(
                        ...
                        Function4(this::toDrawableMap))
    }

    private fun toDrawableMap(originalLocation: Location, scaleFactor: Float, rotateAngle: Degree, footmarks: List<Location>): UseMapView.Sink.DrawableMap {
        return UseMapView.Sink.DrawableMap(originalLocation, scaleFactor, rotateAngle, footmarks)
    }
